...
fun AuthScreen() {
    ...
    Box(modifier = Modifier
        ...
        Column(modifier = Modifier
            ...
            Text(text = stringResource(id=R.string.sign_in_with), color = Color.White)
            Row(
                ...
                Button(onClick = {},
                    ...
                    Row(
                        ...
                        Text(text = stringResource(id=R.string.sign_with_google),
                            color = Color.Black)
                    }
                }
                ...
                Button(onClick = {},
                    ...
                    Row(
                        ...
                        Spacer(modifier = Modifier.size(24.dp))
                        Text(text = stringResource(id=R.string.sign_with_facebook),
                            color = Color.Black)
                    }
                }
            }
